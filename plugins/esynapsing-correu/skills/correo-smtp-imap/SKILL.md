...
- Nunca pidas ni aceptes contraseñas del buzón dentro de la conversación. Si falta configuración, abre el configurador (ver abajo): pide la contraseña por teclado en su propia ventana, y así no pasa por el chat.
